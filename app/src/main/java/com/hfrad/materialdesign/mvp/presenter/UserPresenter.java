...
import com.hfrad.materialdesign.mvp.presenter.list.IRepositoryListPresenter;
import com.hfrad.materialdesign.mvp.view.UserView;
import com.hfrad.materialdesign.mvp.view.list.RepositoryItemView;
...
public class UserPresenter extends MvpPresenter<UserView> {
    ...
    public UserPresenter(Picture user) {
        this.user = user;
